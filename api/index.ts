...
// Run initDB on every request (skips if already done)
...
// Labs
app.get('/api/labs', async (_req: any, res: any) => {
  try {
...
// Experiments
app.get('/api/experiments/:labId', async (req: any, res: any) => {
  try {
...
app.get('/api/experiment/:id', async (req: any, res: any) => {
  try {
...
app.post('/api/experiments', async (req: any, res: any) => {
...
// Contributions
app.get('/api/contributions/:experimentId', async (req: any, res: any) => {
  try {
...
app.post('/api/contributions', async (req: any, res: any) => {
...
app.put('/api/contributions/:id', async (req: any, res: any) => {
...
app.delete('/api/contributions/:id', async (req: any, res: any) => {
  try {
...
app.post('/api/contributions/:id/upvote', async (req: any, res: any) => {
